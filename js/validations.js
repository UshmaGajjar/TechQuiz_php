...
function validate_registeration()
{
	...
	{
		$("#year").addClass("bgRed");
		$("#month").addClass("bgRed");
		$("#day").addClass("bgRed");
		flag=1;
	}
	else
	{
		$("#year").removeClass("bgRed");
		$("#month").removeClass("bgRed");
		$("#day").removeClass("bgRed");
	}
...
function checkYear()
	...
	/*function validate_new_que()
	{
		var flag=0;
		if($("#new_que").val().length == 0)
		{
			$("#new_que").css({'background-color':'#fff'});
		}
		else
		{
			$("#new_que").removeClass('bgRed');
		}	
		return false;
	}*/